...
실제 서비스에 적용하기 전에, 등록한 기기에서 오퍼월과 광고 참여를 확인할 수 있습니다.
...
> 아래 화면 절차는 **Android 기준**입니다. iOS 는 설정 앱에서 IDFA 를 확인할 수 없으므로,
> 이 페이지 하단의 앱 코드(`getAdid()`)로 조회하세요.
...
해당 화면의 **내 광고 ID** 또는 **이 기기의 광고 ID** 라는 항목에 적혀 있는 문자열이 광고 ID 입니다.
